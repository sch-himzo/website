...
@section('content')
    <h1 class="page-header with-description">Főoldali beállítások &raquo;
        <button type="button" data-toggle="modal" data-target="#new" class="btn btn-lg btn-default"><i class="fa fa-plus"></i> Új üzenet</button>
    </h1>
...
@section('modals')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('admin.slides.edit', ['slide' => $slide]) }}" class="btn btn-default">Szerkesztés</a>
                        <a href="{{ route('admin.slides.delete', ['slide' => $slide]) }}" class="btn btn-danger">Törlés</a>
                        @if($slide->number != 1)
                            <a href="{{ route('admin.slides.up', ['slide' => $slide]) }}" class="btn btn-default">
                                <i class="fa fa-arrow-up"></i>
                            </a>
                        @endif
                        @if($slide->number != $slides->count())
                            <a href="{{ route('admin.slides.down', ['slide' => $slide]) }}" class="btn btn-default">
    ...
    <div class="modal fade" id="new">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.slides.new') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-header">
