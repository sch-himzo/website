...
<br><a style="text-decoration:none; color:#069;" href="https://himzo.sch.bme.hu/activate/{{ $user->activate_token }}">https://himzo.sch.bme.hu/user/activate/{{ $user->activate_token }}</a>
